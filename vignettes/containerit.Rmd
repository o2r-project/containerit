...
dockerfile_object <- dockerfile(from = "sf1.Rmd", silent = TRUE, 
...
```{r resources}
response <- file.copy(from = system.file("script_resources/", 
                                         package = "containerit"),
                      to = temp_workspace, recursive = TRUE)


dockerfile_object <- dockerfile("script_resources/",
              copy = "script_dir",
